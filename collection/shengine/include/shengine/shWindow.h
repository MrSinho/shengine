...
extern uint8_t shClearWindow(ShWindow* window);

extern uint8_t shWindowCreateSurface(ShEngine* p_engine);

extern uint8_t shUpdateInput(ShWindow* p_window);

extern uint8_t shGetWindowSize(ShWindow* p_window);

extern uint8_t shUpdateWindow(ShEngine* p_engine);
